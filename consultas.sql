...
SELECT 
	...
	co.inf_tec as 'Nro. Informe Tecnico',
	co.inf_leg as 'Nro. Informe Legal',
	co.sum_tran as 'Nro. Contrato de Suministro y Transporte',
	co.p_sum as 'Precio de Suministro',
	co.p_tran as 'Precio de Transporte',
	co.arrend as 'Nro. Contrato de Arrendamiento de Tanques y/o Vaporizadores',
	co.p_tk as 'Precio de Arrendamiento de Tanques',
	co.p_vap as 'Precio de Arrendamiento de Vaporizadores',
	co.asesor as 'Nro. de Contrato de Asesoramiento y Mantenimiento de Tanques',
	co.p_ase as 'Precio de Asesoramiento y Mantenimiento de Tanques',
	co.ser_int as 'Nro. de Contrato de Servicio Integral de Tanques',
	co.tipo as 'Tipo de Contrato',
	co.garantia as 'Garantia (Bs)',
	co.fecha as 'Fecha Deposito de Garantia',
	co.compr as 'Nro. Comprobante',
	co.ini as 'Fecha Firma de Contrato',
	co.fin as 'Fecha Finalizacion de Contrato',
	co.estado as 'Estado de Contrato',
	a.inf_tec as 'Nro. Informe Tecnico(ADENDA)',
	a.inf_leg as 'Nro. Informe Legal(ADENDA)',
	a.sum_tran as 'Nro. Contrato de Suministro y Transporte(ADENDA)',
	a.p_sum as 'Precio de Suministro (ADENDA)',
	a.p_tran as 'Precio de Transporte (ADENDA)',
	a.arrend as 'Nro. Contrato de Arrendamiento de Tanques y/o Vaporizadores(ADENDA)',
	a.p_tk as 'Precio de Arrendamiento de Tanques(ADENDA)',
	a.p_vap as 'Precio de Arrendamiento de Vaporizadores(ADENDA)',
	a.asesor as 'Nro. de Contrato de Asesoramiento y Mantenimiento de Tanques(ADENDA)',
	...
	a.compr as 'Nro. Comprobante(ADENDA)',
...
FROM CLIENTE c 
	...
	INNER JOIN CONTRATO co ON sc.id_scliente = co.id_scliente 
...
SELECT
	...
	tk.num_ph as 'Nro. Certificado de Prueba Hidraulica',
